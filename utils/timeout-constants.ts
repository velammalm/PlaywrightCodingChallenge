...
/**
 * Timeout constant for Playwright's expect function, set to 7000 milliseconds (7 seconds).
 */
...
/**
 * Timeout constant for Playwright's test functions, set to 180000 milliseconds (3 minutes).
 */
export const TEST_TIMEOUT = 3 * 60 * 1000;
